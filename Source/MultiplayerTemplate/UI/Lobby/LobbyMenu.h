...
#include "MultiplayerTemplate/UI/Lobby/ConnectedPlayer.h"
#include "MultiplayerTemplate/UI/Lobby/CharacterSelect.h"
#include "MultiplayerTemplate/UI/Lobby/GameSettings.h"
 ...
 */
UCLASS()
class MULTIPLAYERTEMPLATE_API ULobbyMenu : public UUserWidget
{
	GENERATED_BODY()
